...
app = Flask(__name__)
sockets = SocketIO(app, cors_allowed_origins="*",port=5001)
algorithm_instance = Algorithm()

config_manager = SessionConfigManager("sesison_config.json")
...
router = Router(app, sockets, MqttManager, config_manager, data_processor, MeasurandCalculator, algorithm_instance.on_threshold_received)
